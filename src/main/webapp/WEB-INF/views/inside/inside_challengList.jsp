            ...
            <div id="body">
                ...
                <section id="allWrap"><!--전체 감싸는 박스-->
                    ...
                    <div id="tableWrap">
                        <table>
                            <tr id="trTitle">
                                <th id="date">날짜</th><th id="name">이름</th><th id="result">결과</th><th id="point">받은포인트</th>
                            </tr>
                            <tr id="content"><!--반복분 부분-->
                                <td class="date">2000-11-11</td><td class="name">작심삼일</td><td class="result">성공</td><td class="point">500point</td>
                            </tr>
                        </table>
                    </div>
                </section>
